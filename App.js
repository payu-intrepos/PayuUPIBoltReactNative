...
import { sha512 } from 'js-sha512';
 const { PayUUPIBoltUISdk } = NativeModules;
...
export default App= () => {
    ...
    const [phone, setPhone] = useState('917607833550');//Put your mobile number for testing
    ...
    useEffect(() => {
        const eventEmitter = new NativeEventEmitter(PayUUPIBoltUISdk);
   ...
   //Unregister eventEmitters here
    ...
    payURegisterAndPay = () => {
       var initConfig = createSDKConfig()
       PayUUPIBoltUISdk.isUPIBoltSDKAvailable( 
           (response) => {
    ...
    upiBoltSettings = () => {
       ...
       PayUUPIBoltUISdk.isUPIBoltSDKAvailable(
           (response) => {
            if (response.isSDKAvailable == 'true'){
                PayUUPIBoltUISdk.payUUPIBoltUserSettings("ALL");
